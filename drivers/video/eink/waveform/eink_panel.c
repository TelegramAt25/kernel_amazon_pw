...
#define WF_UPD_MODE_REAGL       8       //  None flashing page turn
#define WF_UPD_MODE_REAGLD      9       //  None flashing page turn with dithering
#define WF_UPD_MODE_GL4        10
#define WF_UPD_MODE_GL16_INV   11
...
static bool panel_upd_mode_valid(int upd_mode)
{
    ...
    switch ( upd_mode )
    {
        ...
        case WF_UPD_MODE_RGL:
        case WF_UPD_MODE_RGLD:
        case WF_UPD_MODE_GL4:
        case WF_UPD_MODE_GL16_INV:
            result = true;
        break;
    }
