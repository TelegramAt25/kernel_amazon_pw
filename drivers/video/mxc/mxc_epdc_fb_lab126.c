...
static void set_waveform_modes(struct mxc_epdc_fb_data *fb_data)
{
    ...
    waveform_modes.mode_gl4 = einkwf_panel_get_waveform_mode(WF_UPD_MODE_GL4);
    waveform_modes.mode_gl16_inv = einkwf_panel_get_waveform_mode(WF_UPD_MODE_GL16_INV);
