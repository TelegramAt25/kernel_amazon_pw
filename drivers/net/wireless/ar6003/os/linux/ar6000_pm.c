...
#ifndef LAB126    
    // This delay does not seem to be necessary for LAB platforms (Whitney and Celeste)
    // Primarily meant to allow WiFi chip, SDIO stack etc to be ready before loading the firmware
    mdelay(100);
#endif
