...
static struct lis3dh_acc_platform_data lis3dh_data = {
	...
	.negate_y = 0,
	.negate_z = 0,
	.gpio_int1 = IOMUX_TO_GPIO(MX50_PIN_SD1_D2),
	.gpio_int2 = IOMUX_TO_GPIO(MX50_PIN_SD1_D3),
};
...
static struct i2c_board_info mxc_i2c0_board_info_ice[] = {
	...
	{	/* Yoshime ALS MAX44009 */
	 .type = "yoshime_max44009",
	 .addr = 0x4A,
	},
	{
	 .type = "lis3dh_acc_misc",
	 .addr = 0x18,
...
static struct hall_platform_data mx50_yoshime_hall_platform_data = {
...
static void __init mxc_board_init(void)
{
	...
	if (mx50_board_is(BOARD_ID_ICEWINE) || mx50_board_is(BOARD_ID_ICEWINE_WFO) ||
		mx50_board_rev_greater_eq(BOARD_ID_YOSHIME_3)) {
	...
	if(mx50_board_is_celeste() || mx50_board_is(BOARD_ID_YOSHIME) || mx50_board_is(BOARD_ID_ICEWINE)){
		 mx5_usbh1_init();
	}
