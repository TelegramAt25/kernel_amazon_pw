...
#define WF_UPD_MODE_RGL          8      //  REAGL (non-flashing update)
#define WF_UPD_MODE_RGLD         9      //  REAGLD (non-flashing update with dithering)
#define WF_UPD_MODE_GL4         10      //  GL4 (4 gray transition)
#define WF_UPD_MODE_GL16_INV    11      // Inverted GL16 (black to black transition)
